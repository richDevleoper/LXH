...
public class MakeVO {
	...
	private String cirTchComName;
	private String cirWorkMemNo;
	private String cirWorkMemName;
	private String cirTeamLeaderNo;
	private String cirTeamLeaderName;
	...
	private String cirDeptCode;
	private String cirDeptName;
	...
	private String cirLName;
	private String cirLeaderdeptName;
	...
	private String kudJobxName;
	private String kudPositionName;
	...
	public String getKudJobxName() {
		return kudJobxName;
	}
	public String getKudPositionName() {
		return kudPositionName;
	}
	...
	public void setKudJobxName(String kudJobxName) {
		this.kudJobxName = kudJobxName;
	}
	...
	public String toString() {
		return "MakeVO [cirCode=" + cirCode + ", cirRegNum=" + cirRegNum + ", cirName=" + cirName + ", deptCode="
				+ deptCode + ", deptName=" + deptName + ", comWorkPlace=" + comWorkPlace + ", cirTchComNo="
				+ cirTchComNo + ", cirTchComName=" + cirTchComName + ", cirWorkMemNo=" + cirWorkMemNo
				+ ", cirWorkMemName=" + cirWorkMemName + ", cirTeamLeaderNo=" + cirTeamLeaderNo + ", cirTeamLeaderName="
				+ cirTeamLeaderName + ", cirRecordCont=" + cirRecordCont + ", cirMemCnt=" + cirMemCnt + ", cirRegUser="
