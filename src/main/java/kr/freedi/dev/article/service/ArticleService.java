...
public class ArticleService {
	...
	final String ATTACH_PREFIX = "article";
	...
	public List<ArticleVO> selectList(ArticleSearchVO searchVO) {
		List<ArticleVO> resultList = dao.selectList("Article.selectList", searchVO);
		//첨부파일목록
	...
	public void insert(ArticleVO articleVO) throws Exception {
		...
		Integer fkey = (Integer)dao.selectOne("Article.selectNextFkey");
		articleVO.setFkey(fkey);
		articleVO.setPkey(0);
		articleVO.setOkey(0);
		articleVO.setGkey(0);
