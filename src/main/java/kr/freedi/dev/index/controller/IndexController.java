...
public class IndexController {
	...
	public String cslIndexHandler(HttpServletRequest request,
			ModelMap model,
	...
	public String cslSubHandler(HttpServletRequest request, @ModelAttribute("searchVO")CommonVO searchVO)throws Exception {
	...
	public String indexHandler(HttpServletRequest request, ModelMap model) throws Exception {
		...
		articleSearchVO.setBoardKey(1);
		articleSearchVO.setRecordCountPerPage(3);
		model.addAttribute("noticeList", articleService.selectRecentListWithoutFileList(articleSearchVO));

		//main visual banner
		BannerVO visualBannerVO = new BannerVO();
		visualBannerVO.setLocateTyp("MAIN_VISUAL");
		...
		linkVO.setLocateTyp("DEF_LINK_01");
		linkVO.setActFlg("Y");
		model.addAttribute("linkList", linkService.selectFullList(linkVO));
		
		PopupVO popupVO = new PopupVO();
		popupVO.setLocateTyp("DEF_POPUP_01");
		popupVO.setActFlg("Y");
		model.addAttribute("popupList", popupService.selectFullList(popupVO));
		
		//주요사업
		CodeVO codeVO = new CodeVO();
		codeVO.setCodeGrpId("MAINBIZ");
		codeVO.setActFlg("Y");
		model.addAttribute("mainBizList", codeService.selectFullList(codeVO));
	...
	public String engIndexHandler(HttpServletRequest request, ModelMap model) throws Exception {
		
		//article
		ArticleSearchVO articleSearchVO = new ArticleSearchVO();
		articleSearchVO.setBoardKey(5);
		model.addAttribute("noticeList", articleService.selectRecentListWithoutFileList(articleSearchVO));
		
		//banner
		//BannerVO bannerVO = new BannerVO();
		//bannerVO.setLocateTyp("DEF_BNR_01");
		//bannerVO.setActFlg("Y");
	...
	@RequestMapping("/eng/sub.do")
	public String engSubHandler(HttpServletRequest request, @ModelAttribute("searchVO")CommonVO searchVO)throws Exception {
