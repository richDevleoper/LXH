                ...
                <div class="inner">
                    ...
                    <div class="search-box">
                        <div class="search-form">
                        	<form:form commandName="reportSearchVO" id="defaultForm" method="get" action="./team.do" >
                    ...
                    <div class="new_group">
                        <div class="tab-group">
                            <div class="tab-btn center">
                                ...
                                <button type="button" param="2" class="on" >분임조활동검색</button>
...
<c:forEach items="${reportList}" var="item" varStatus="i">
                                            <li class="border">
                                                ...
                                                <p class="list">
                                                    <a href="/report/SearchView.do?menuKey=69&repCode=${item.repCode}" title="${item.repName}">과제명 : ${item.repName}</a>
