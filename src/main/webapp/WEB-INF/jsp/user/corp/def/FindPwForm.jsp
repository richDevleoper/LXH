...
<form:form commandName="corpUserVO" id="defaultForm" name="defaultForm" method="post" action="findPw.do">
		...
		<table cellpadding="0" class="tb_base" summary="">
			...
			<tbody class="write">
				...
				<tr>
					...
					<td>
						<input type="text" id="chrEmail" name="chrEmail" class="validate[maxSize[50],custom[email]] tb_ipty" maxlength="50" style="width:240px;" title="이메일"/>
					</td>
				</tr>
			</tbody>
		</table>
