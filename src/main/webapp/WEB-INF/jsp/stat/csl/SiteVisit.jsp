		...
		,success : function(data, stat, xhr) {
			...
			$('#chartYear').bind('click', function(evt){
	            ...
	            if(firstPoint != null){
		            ...
		            statMonth(statTyp, label.replace(/\D/g,''));
	            }
			});
		}
		,complete : function(){
...
function statMonth(statTyp, year){
		...
		,success : function(data, stat, xhr) {
			...
			$('#chartMonth').bind('click', function(evt){
	            ...
	            if(firstPoint != null){
		            ...
		            statDate(statTyp, year, label.replace(/\D/g,''));
	            }
			});
		}
		,complete : function(){
...
function statDate(statTyp, year, month){
		...
		,success : function(data, stat, xhr) {
			...
			$('#chartDate').bind('click', function(evt){
	            ...
	            if(firstPoint != null){
		            ...
		            statHour(statTyp, year, month, label.replace(/\D/g,''));
	            }
			});
		}
		,complete : function(){
...
function statHour(statTyp, year, month, date){
		...
		,success : function(data, stat, xhr) {
			if(data != null && data.statSize > 0){
				...
				window.chartYMDH = new Chart(document.getElementById("chartHour").getContext("2d"), {
				    ...
				    ,data: {
					    ...
					    ,datasets: [
					        {
					            label: year + "년 " + month + "월 " + date + "일, 시간별통계"
			...
			$('#chartHour').bind('click', function(evt){
	            ...
	            if(firstPoint != null){
		            ...
		            statMinute(statTyp, year, month, date, label.replace(/\D/g,''));
	            }
			});
		}
		,complete : function(){
...
function statMinute(statTyp, year, month, date, hour){
			...
			if(data != null && data.statSize > 0){
				...
				window.chartYNDHM = new Chart(document.getElementById("chartMinute").getContext("2d"), {
				    ...
				    ,data: {
					    ...
					    ,datasets: [
					        {
					            label: year + "년 " + month + "월 " + date + "일 " + hour + "시, 분별통계"
...
<div id="chartAllWrap" style="width:100%;border:0px solid red;"></div>
<div style="height:60px;"></div>
<!--  
<div id="chartYearWrap" style="display:none;width:100%;border:0px solid red;"></div>
<div style="height:60px;"></div>
-->
