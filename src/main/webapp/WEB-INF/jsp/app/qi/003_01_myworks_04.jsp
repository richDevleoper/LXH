                                        ...
                                        <tbody>
                                                ...
                                                <td colspan="3">
                                                    <div class="row">
                                                        <div class="col s12 input-text">
                                                            <input type="text" id="text1" name="" value="예시) 진행중인 과제명" title="과제명을 입력해주세요.">
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        <div class="col s12 input-text">
                                                            <input type="text" id="text2" name="" value="직접입력" title="제품군을 입력해주세요.">
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th><label for="select4"><span class="asterisk">*</span>Leader</label></th>
                                                <td colspan="3">
                                                    <div class="row">
                                            ...
                                            <tr>
                                                <th><label for="select6">분임조</label></th>
                                                <td>홍길동</td>
                                                <th>분임조장</th>
                                                <td></td>
                                            </tr>
                                                                    ...
                                                                    <div class="list-table list">
                                                                        <table>
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>                                                                                    
                                                                                    <td>챔피온</td>
                                                                                    <td>자동차소재부품 사업부>경량화사업담당>자동차소재부품두명과학플라스틱연구PJT</td>
                                                                                    <td>홍길동</td>
                                                                                    <td>책임</td>
                                                                                    <td>팀장</td>
                                                                                    <td>BB</td>
