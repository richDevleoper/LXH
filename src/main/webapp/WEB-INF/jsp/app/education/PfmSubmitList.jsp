...
<body>
                        ...
                        <div class="list-wrap">
                            <div class="list-search">
                           	<form:form commandName="EducationSearchVO" id="defaultForm" method="get" action="pfmsubmit.do" >
                            ...
                            <div class="list-header">
                                <p class="title">과정 전체 ${totalCount}</p>
                                <span class="bar"></span>
...
<script type="text/javascript">
	...
	function onclick_educationInfo(eduCode){
		location.href="./pfmsubmitdetail.do?menuKey=68&eduCode="+eduCode;		
	}
