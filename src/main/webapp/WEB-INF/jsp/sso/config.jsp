...
/***[SERVICE CONFIGURATION : 업무시스템 설정]***********************************************************************/
	private String SERVICE_NAME = "G-PORTAL"; //서비스 이름 : 시스템별로 중복되지 않도록 설정
	private String SERVER_URL 	= "http://lxh.lghausys.com/"; //시스템 접속 URL
...
/***[SSO CONFIGURATION] : 로그인 서버 및 데몬 서버 설정]***********************************************************************/
	...
	private static String ND_URL1 = "http://lxhsso.lghausys.com:5481";
	private static String ND_URL2 = "http://lxhsso.lghausys.com:5481";
