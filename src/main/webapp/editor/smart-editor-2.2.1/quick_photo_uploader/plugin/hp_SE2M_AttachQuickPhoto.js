...
nhn.husky.SE2M_AttachQuickPhoto = jindo.$Class({		
	...
	$ON_ATTACHPHOTO_OPEN_WINDOW : function(){			
		...
		this.htPopupOption.sProperties = "left=0,top=0,width=480,height=380,scrollbars=no,location=no,status=0,resizable=no";
	...
	makePopupURL : function(){
		var sPopupUrl = "/file/smartEditorUploadForm.do"; 
		return sPopupUrl;
	},
	...
	$ON_SET_PHOTO : function(aPhotoData){
		...
		try{
			...
			for(var i = 0; i <aPhotoData.length; i++){				
				...
				aPhotoInfo = {
				    sName : htData.sFileAlt || htData.sFileName || "",
