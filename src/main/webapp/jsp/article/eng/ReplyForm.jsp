...
<link type="text/css" rel="stylesheet" href="<c:url value='/eng/attachfile/css/jquery.fileupload.css'/>" />
<link type="text/css" rel="stylesheet" href="<c:url value='/eng/attachfile/css/jquery.fileupload-ui.css'/>" />
<script type="text/javascript" src="<c:url value='/eng/attachfile/js/jquery.fileupload-tmpl.js'/>"></script>
<script type="text/javascript" src="<c:url value='/eng/attachfile/js/jquery.iframe-transport.js'/>"></script>
<script type="text/javascript" src="<c:url value='/eng/attachfile/js/jquery.fileupload.js'/>"></script>
<script type="text/javascript" src="<c:url value='/eng/attachfile/js/jquery.fileupload-process.js'/>"></script>
<script type="text/javascript" src="<c:url value='/eng/attachfile/js/jquery.fileupload-validate.js'/>"></script>
<script type="text/javascript" src="<c:url value='/eng/attachfile/js/jquery.fileupload-ui.js'/>"></script>
<script type="text/javascript" src="<c:url value='/eng/attachfile/js/jquery.fileupload-jquery-ui.js'/>"></script>
<script type="text/javascript" src="<c:url value='/eng/attachfile/js/attachfile-fileuploader.js'/>"></script>
	...
	<table class="article_form" summary="현재 누르신 글의 제목,작성자,작성일,조회수,첨부,내용에 대한 테이블 정보입니다.">
		...
		<tbody class="skin2">
			...
			<tr>
				...
				<td colspan="3" style="vertical-align:top;">
					<div><a href="#none" onclick="return viewParentContent(this);" class="at_btn_st2">view Original Article</a></div>
					<div style="margin-top:10px;display:none;">
						${fn:replace(parentVO.content, LF, '<br />')}
					</div>
				</td>
...
<div class="article_bottom">
	<!-- 버튼 -->
	<p class="ta_r">
	<a href="#none" onclick="return insert();" class="at_btn_st2">Save</a>
	<a href="#none" onclick="return list();" class="at_btn_st2">Cancel</a>
	</p>
	<!-- //버튼 -->
</div>
<!-- //게시글 쓰기 -->
