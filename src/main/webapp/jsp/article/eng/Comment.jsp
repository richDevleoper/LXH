...
function cmntList(clearFlag){
	...
	$.ajax({
		url:'/eng/articlecomment/fullList.do'
	    ,method:"post"
		,dataType:'json'
		,async:true
		,data:{
...
function cmntInsert(){
	...
	$.ajax({
		url:'/eng/articlecomment/insert.do'
	    ,method:"post"
		,dataType:'json'
		,async:true
		,data:{
...
function cmntUpdate(articleCommentKey){
	...
	$.ajax({
		url:'/eng/articlecomment/update.do'
	    ,method:"post"
		,dataType:'json'
		,async:true
		,data:{
...
function cmntReply(parentKey){
	...
	$.ajax({
		url:'/eng/articlecomment/reply.do'
	    ,method:"post"
		,dataType:'json'
		,async:true
		,data:{
...
function cmntDisable(articleCommentKey){
	...
	$.ajax({
		url:'/eng/articlecomment/disable.do'
	    ,method:"post"
		,dataType:'json'
		,async:true
		,data:{
...
<!-- 댓글영역 -->
<div class="cmnt_view">
	<p class="cmnt_count"><span>Comment</span> <span id="cmntCnt"></span></p>
	<div class="cmntListWrap">
		<ul id="cmntList">
			<li style="display:none;">
				<div class="cmntView">
					<p>
						<span class="user viewWriter">Writer</span>
						<span class="date viewFrstOperDt">Date</span>
						<a class="btnUpdateForm" href="#none" onclick="cmntUpdateForm();"><img src="/eng/img/article/btn_rp_modi.gif" alt="댓글수정" /></a>
						<a class="btnDisableForm" href="#none" onclick="cmntDisableForm();"><img src="/eng/img/article/btn_rp_del.gif" alt="댓글삭제" /></a>
					</p>
					<c:if test="${isUseGrpForComment}">
						<p class="answer"><a class="btnReplyForm" href="#none" onclick="cmntReplyForm();" >Reply</a></p>
					</c:if>
				...
				<div class="cmnt_write cmntUpdate" style="display:none;">
					<p class="cancel"><a id="btnCancel" href="#none" onclick="cmntUpdateCancel(this);">Cancel</a></p>
					<fieldset>
						<legend class="hidden">댓글수정</legend>
						<div style="padding-bottom:10px;">
							<label>Writer</label> <input type="text" id="cmntUpdateWriter" name="cmntUpdateWriter" readonly="readonly" value="" maxlength="20" style="width:120px;"/>
							<label id="cmntUpdateWriterPwdLabel">Password</label> <input type="password" id="cmntUpdateWriterPwd" name="cmntUpdateWriterPwd" maxlength="20" style="width:120px;"/>
							<label>Limit</label><span class="text_num"><b>0</b> / 600Byte</span>
						</div>
						<textarea id="cmntUpdateContent" name="cmntUpdateContent" onkeyup="checkContent(this);" onblur="checkContent(this);"></textarea>
						<p class="btn_signup"><a class="btnUpdate" href="#none" onclick="cmntUpdate(); return false;">Save</a></p>
					</fieldset>
				</div>
				<div id="cmntDisable" class="cmnt_write" style="display:none;">
					<p class="cancel"><a id="btnCancel" href="#none" onclick="cmntDisableCancel(this);">Cancel</a></p>
					<fieldset>
						<legend class="hidden">댓글삭제</legend>
						<div style="padding-bottom:10px;">
							<label>Writer</label> <input type="text" id="cmntDisableWriter" name="cmntDisableWriter" readonly="readonly" value="" maxlength="20" style="width:120px;"/>
							<label id="cmntDisableWriterPwdLabel">Password</label> <input type="password" id="cmntDisableWriterPwd" name="cmntDisableWriterPwd" maxlength="20" style="width:120px;"/>
							<a class="btnDisable" onclick="cmntDisable(); return false;" href="#none" style="padding:3px 6px;border:1px solid #ddd;">Delete</a>
						</div>
					</fieldset>
		...
		<c:if test="${isUseGrpForComment}">
			<div id="cmntWrite" class="cmnt_write">
				<fieldset>
					...
					<div style="padding-bottom:10px;">
						<label>Writer</label> <input type="text" id="cmntWriter" name="cmntWriter" value="${userSession.userNm}" maxlength="20" style="width:120px;"/>
						<c:if test="${!userSession.loginUser}">
							<label>Password</label> <input type="password" id="cmntWriterPwd" name="cmntWriterPwd" maxlength="20" style="width:120px;"/>
						</c:if>
						<label>Limit</label><span class="text_num"><b>0</b> / 600Byte</span>
					</div>
					<textarea id="cmntContent" name="cmntContent" onkeyup="checkContent(this);" onblur="checkContent(this);"></textarea>
					<p class="btn_signup"><a href="#none" onclick="cmntInsert(); return false;">Save</a></p>
				</fieldset>
			</div>
		</c:if>
		<div id="cmntReply" class="cmnt_write" style="margin-top:20px;display:none;">
			<p class="cancel"><a id="btnCancel" href="#none" onclick="cmntReplyCancel(this);">Cancel</a></p>
			<fieldset>
				<legend class="hidden">댓글작성</legend>
				<div style="padding-bottom:10px;">
					<label>Writer</label> <input type="text" id="cmntReplyWriter" name="cmntReplyWriter" value="${userSession.userNm}" maxlength="20" style="width:120px;"/>
					<c:if test="${!userSession.loginUser}">
						<label>Password</label> <input type="password" id="cmntReplyWriterPwd" name="cmntReplyWriterPwd" maxlength="20" style="width:120px;"/>
					</c:if>
					<label>Limit</label><span class="text_num"><b>0</b> / 600Byte</span>
				</div>
				<textarea id="cmntReplyContent" name="cmntReplyContent" onkeyup="checkContent(this);" onblur="checkContent(this);"></textarea>
				<p class="btn_signup"><a id="btnReply" href="#none" onclick="cmntReply(); return false;">Save</a></p>
			</fieldset>
		</div>
	</div>
</div>
