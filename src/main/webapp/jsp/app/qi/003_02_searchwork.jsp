...
<body>
                        ...
                        <div class="list-wrap">
                            <div class="list-search">
                                ...
                                <div class="search-form row">
                                    <div class="form-inline form-input col s12">
                                        ...
                                        <div class="col s7 align-right"></div>
                                    </div>                                    
                                    <div class="col s2 align-right">
                                    ...
                                    <div class="inr">
                                        <ul>
                                            <li class="border">
                                                ...
                                                <p class="list">
                                                    <a href="/app/003_02_searchwork_01.do?menuKey=69" title="바로가기">과제명 : 예시) 23년 신제품 싸움닭 초기 유동관리를 통한 품질 안정화 과제</a>
