...
<form:form commandName="corpUserVO" id="defaultForm" name="defaultForm" method="post" action="leave.do">
<input type="hidden" id="userId" name="userId" value="${userSession.corpUserVO.userId }" />
