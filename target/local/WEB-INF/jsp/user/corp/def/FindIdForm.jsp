...
<form:form commandName="corpUserVO" id="defaultForm" name="defaultForm" method="post" action="findId.do">
<div style="height:400px;">
	<div id="findIdForm_layer">
		<table cellpadding="0" class="tb_base" summary="">
			...
			<tbody class="write">
				<tr>
					<th><label for="userNm">담당자명</label></th>
					<td>
						<input type="text" id="userNm" name="userNm" class="validate[required,maxSize[20]] tb_ipty" maxlength="20" style="width:192px;" title="이름" />
					</td>
				</tr>
				<tr>
					<th><label for="chrMob1">휴대폰번호</label></th>
					<td>
						<input id="chrMob1" name="chrMob1" value="${paramVO.chrMob1 }" class="validate[required, maxSize[3],custom[integer]] tb_ipty" maxlength="3" style="width:50px;" title="휴대폰번호 앞자리"/>
						-
						<input id="chrMob2" name="chrMob2" value="${paramVO.chrMob2 }" class="validate[required, maxSize[4],custom[integer]] tb_ipty" maxlength="4" style="width:50px;" title="휴대폰번호 중간자리"/>
						-
						<input id="chrMob3" name="chrMob3" value="${paramVO.chrMob3 }" class="validate[required, maxSize[4],custom[integer]] tb_ipty" maxlength="4" style="width:50px;" title="휴대폰번호 끝자리"/>
					</td>
				</tr>
			</tbody>
		</table>
